...
<head>
    ...
    <meta property="og:url" content="http://costanoticiascni.com/">
    <meta property="og:title" content="Costa Noticias | CN&">
    <meta property="og:description" content="Sitio de noticias activas, al día, de sincelejo y toda la costa caribe colombiana.">
    <meta property="og:image" content="">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="http://costanoticiascni.com/">
    <meta property="twitter:title" content="Costa Noticias | CN&">
    <meta property="twitter:description" content="Sitio de noticias activas, al día, de sincelejo y toda la costa caribe colombiana.">
    ...
    <style>
        ul li a .cap-cat{text-transform: lowercase !important;}
    </style>

	<!-- Document Title
	============================================= -->
	<title>Costa Noticias | CN&</title>
			...
			<div class="container clearfix">
				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-auto">
						...
						============================================= -->
						<ul id="top-social">
							<li><a href="https://www.facebook.com/ExtraSincelejo" class="si-facebook"><span class="ts-icon"><i class="icon-facebook"></i></span><span class="ts-text">Facebook</span></a></li>
							...
							<li><a href="mailto:noticias@costanoticiascni.com" class="si-email3"><span class="ts-icon"><i class="icon-email3"></i></span><span class="ts-text">noticias@costanoticiascni.com</span></a></li>
						</ul><!-- #top-social end -->
			...
			<div class="container">
				<div class="header-row flex-column flex-lg-row justify-content-center justify-content-lg-start">
					...
					<div id="logo" class="mr-0 mr-lg-auto">
						<a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/logo.png" alt="Costa Noticias CN&"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="images/logo@2x.png" alt="Costa Noticias CN&"></a>
					</div><!-- #logo end -->
					...
					<div class="header-row justify-content-between">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link" href="#"><div>Noticias de Sucre</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Judiciales</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Deporte</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Farandula</div></a>
								</li>
								<li class="menu-item">
									<a class="menu-link" href="shop.html"><div>Noticias del Caribe </div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Editorial </div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>¡Que escándalo!</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Política</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Elecciones 2022</div></a>
								</li>
							</ul>
						...
						<form class="top-search-form" action="search.html" method="get">
							<input type="text" name="q" class="form-control" value="" placeholder="Escribe &amp; Pulsa ENTER.." autocomplete="off">
						</form>
